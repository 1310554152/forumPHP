...
$lang = array(
//聊天室描述
"description"=>"欢迎来到迷你论坛聊天室！</a>",
//聊天室标题
"title"=>"校园论坛聊天室",
//第一个到聊天室的欢迎
"firstone"=>"<span style='color:#16a5e9;'>Wellcome to the XJUFE forum chatroom !(produced by gaopeng)</span>",
//当信息有禁止内容时显示
"ban"=>"I am a pig!",
//关键字
...
.mydiv	{ text-align:left; margin:5px; padding:5px; border:1px solid #AAAAAA; background-color:#ffffff; width:600px; }
.inputtext	{ border:0px; border-bottom:1px solid #333333; background-color:transparent;}
.submit	{ height:20px; font:12px; border:1px solid #ff8c05; padding-top:3px; background-color:transparent; }
.contents	{ border:1px solid #CC99FF;margin:5px; margin-top:10px;background-color:#ffffff; overflow:auto;word-break:break-all;word-wrap :break-word;}
...
.time	{ color:#aaaaaa; font-size:12px; font-family:Arial;}
.online	{ margin:5px; padding:0px; display:inline; }
.mybut	{ width:20px; height:20px; padding-top:7px; background-color:#ffffff; text-align:center; font-size:12px; color: #333333;}
.mybut1	{ width:50px; height:20px; padding-top:7px; background-color:#ffffff; text-align:center; font-size:12px; color: #333333;}
</style>
<!-- js代码部分 ----------------------------------------------->
<script>
function $(obj)
...
<div class='contents' style='height:400px;' id='div_contents'>Loading...</div>
</div>

<div class="mydiv login" id='div_name' style='display:block;'>
&nbsp;&nbsp;&nbsp;昵称:<input type=text class="inputtext bg" size=10 id='chat_user' value='' />
...
&nbsp;&nbsp;&nbsp;大小:<input class="inputtext bg" type=text style='width:20px' maxlength=2 id='input_size' value='12' />(px)
...
粗体:<input type=checkbox id='input_bold' class='inputtext' style='border-bottom:0px;' />
窗口:<a class='mybut' href='#' onclick='resize(1)'>+</a>
&nbsp;&nbsp;&nbsp;<a class='mybut' href='#' onclick='resize(0)'>-</a>
&nbsp;&nbsp;&nbsp;<a class='mybut1' href='#' onclick='clearAll()'>清空信息</a>
</div>
...
<input type=button class=submit value='发送消息' onClick="chat_send();$('chat_word').style.height=20;" onFocus="this.blur();"/>
</div>
