...
//取得论坛公告列表
$sql11="select * from news where news_kind='1' ORDER BY news_time DESC limit 0,10";
...
<body>
			...
			<div id="right">
				<div id="block">
					<div id="block-top">
						<a href="news.php?news_kind=1">论坛公告</a>
					</div>
					<div id="block-main">
						<?php
							$i=1;
				...
				<div id="block">
					<div id="block-top">
						<a href="news.php?news_kind=2">学校新闻</a>
					</div>
					<div id="block-main">
						<?php
							$i=1;
				...
				<div id="block">
					<div id="block-top">
						<a href="news.php?news_kind=3">广而告之</a>
					</div>
					<div id="block-main">
						<?php
							$i=1;
