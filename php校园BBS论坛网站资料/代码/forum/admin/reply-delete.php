						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="94%" valign="bottom">
												<span class="STYLE1">您将删除回复详细信息如下，您确定删除么？</span>
											</td>
										</tr>
									</table>
								</td>
								<td>
									<div align="right">
									<span class="STYLE1">
										<a href="reply-delete-confirm.php?reply_id=<?php echo $data1->reply_id?>"><font color="#FF00FF">确认删除</font></a> | <a href="reply-list.php"><font color="#FF00FF">取消删除</font></a>&nbsp;&nbsp;&nbsp;&nbsp;
									</span>
									</div>
								</td>
							</tr>
