			...
			<div id="left">
				<div id="area">
					<div id="delete-confirm">
						<div id="delete-confirm-left">您将删除的新闻信息如下，您确认删除么？</div>
						<div id="delete-confirm-right"><a href="news-delete-confirm.php?news_id=<?php echo $news_id?>"><font color="#FF0000">确认删除</font></a> | <a href="news-list.php"><font color="#FF0000">取消删除</font></a></div>
					</div>
					<div id="area-top">
						<?php
							if($news_kind==1)
