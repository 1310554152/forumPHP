							...
							<tr>
								...
								<td width="248" background="images/main_06.gif">
									<table width="225" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr>
											<td height="17"><div align="right"><a href="../index.php" target="_parent"><font size="2">论坛首页</font></a></div></td>
											<td><div align="right"><a href="../i.php" target="_parent"><font size="2">个人中心</font></a></div></td>
											<td><div align="right"><a href="../logout.php" target="_parent"><font size="2">退出系统</font></a></div></td>
										</tr>
									</table>
								</td>
							</tr>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="35" class="STYLE7"><div align="center"><a href="center-right.php" target="rightFrame">首页</a></div></td>
								...
								<td width="35" class="STYLE7"><div align="center"><a href="#" target="rightFrame">帮助</a></div></td>
								<td>&nbsp;</td>
  							</tr>
						</table>
					</td>
					<td width="248" background="images/main_11.gif">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="75%"><div align="center"><span class="STYLE7">计算机科学与技术（专升本）&nbsp;&nbsp;201731980109</span></div></td>
								<td width="9%">&nbsp;</td>
							</tr>
						</table>
					</td>
