						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="94%" valign="bottom">
												<span class="STYLE1">您将删除的版块的信息如下，您确认删除么？</span>
											</td>
										</tr>
									</table>
								</td>
								<td>
									<div align="right">
									<span class="STYLE1">
										<a href="block-delete-confirm.php?block_id=<?php echo $data1->block_id?>"><font color="#FF00FF">确认删除</font></a> | <a href="block-list.php"><font color="#FF00FF">取消删除</font></a>&nbsp;&nbsp;&nbsp;&nbsp;
									</span>
									</div>
								</td>
							</tr>
